...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Konto zostało utworzone pomyślnie! Sprawdź swój email, aby potwierdzić konto.');
  ...
  const handleGoogleRegister = async () => {
    try {
      ...
      alert(error instanceof Error ? error.message : 'Wystąpił błąd podczas rejestracji z Google');
    }
  };
        ...
        <div className="bg-white/90 backdrop-blur-lg rounded-3xl shadow-xl border border-white/60 p-8">
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <span className="text-slate-700 font-medium">Zarejestruj się z Google</span>
            </button>
          </div>
